...
document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#FFFFFF;border:1px solid #666666;width:220px;height:230px;">');//oldwidth200 height216
...
__ci.document.writeln('select {font-size:12px;background-color:#EFEFEF;}');//font-size:12px;
...
__ci.document.writeln('select.year {width:74px;}');//old64
__ci.document.writeln('select.month {width:68px;}');//old60
...
__ci.document.writeln('input.l {border: 1px solid #CCCCCC;background-color:#EFEFEF;width:20px;height:22px;}');//old width20 height20
__ci.document.writeln('input.r {border: 1px solid #CCCCCC;background-color:#EFEFEF;width:20px;height:22px;}');//old width20 height20
