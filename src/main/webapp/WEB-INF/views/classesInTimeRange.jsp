...
<body>
	<div id="ReportTablesDiv" style="width: 800px">
		...
		<div>
			<h3>汇总交班报表</h3>
			<form action="classesInTimeRange" method="GET">
				...
				<input name="startDate" value="${startDate}" type="text"
					...
					value="${endDate}" readonly="readonly" /> <input
					onclick="checkInput(this)" type="button" value="查看报表" />
			</form>
		</div>
		<br /> <input type="button" value="导出当前报表"
			onclick="window.location.href='getReportingCSVFile?storeId=${storeId}&reportType=classesInTimeRange&startDate=${startDate}&endDate=${endDate}'"></input>
