...
<body>
	<div id="ReportTablesDiv" style="width: 800px">
		...
		<h3>每日报表:</h3>
		<div>
			<form action="dailyReporting" method="GET">
				<input type="hidden" value="${storeId}" name="storeId" id="storeId">

				<input name="dateToReport" value="${dateToReport}" type="text"
					id="dateToReport" size="10" maxlength="10"
					onclick="new Calendar().show(this);" readonly="readonly" /> <input
					type="button" onclick="checkInputOneDay(this)" value="查看报表" />
			</form>
		</div>
		<br /> <input type="button" value="导出当前报表"
			onclick="window.location.href='getReportingCSVFile?storeId=${storeId}&reportType=dailyReporting&startDate=${dateToReport}&endDate=${dateToReport}'"></input>
