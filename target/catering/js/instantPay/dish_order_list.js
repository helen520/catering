	...
	function renderDishOrders(dishOrderListPanel, dishOrderList) {
		...
		for ( var i in dishOrderList) {
			...
			if (dishOrder) {
				...
				var dishOrderCaptionHtml = dishOrder.deskName;
				dishOrderCaptionHtml += dishOrder.customerCount
						+ $.i18n.prop('string_ren');
				dishOrderCaptionHtml += "&yen;" + dishOrder.totalPrice;
				dishOrderCaptionHtml += " " + $.i18n.prop('string_danHao')
						+ ":" + dishOrderBriefId;
				dishOrderCaptionHtml += dishOrder.customerCount
				dishOrderCaptionHtml += dishOrder.totalPrice;
