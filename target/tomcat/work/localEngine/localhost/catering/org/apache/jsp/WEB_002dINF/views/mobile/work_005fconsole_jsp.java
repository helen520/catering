...
public final class work_005fconsole_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/WEB-INF/views/mobile/desk_view.jsp");
    _jspx_dependants.add("/WEB-INF/views/mobile/dish_view.jsp");
    _jspx_dependants.add("/WEB-INF/views/mobile/dish_order_view.jsp");
    _jspx_dependants.add("/WEB-INF/views/mobile/checkout_view.jsp");
    _jspx_dependants.add("/WEB-INF/views/mobile/../shiftClassDialog.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<link rel=\"stylesheet\" href=\"../css/mobile/work_console.css\">\n");
      out.write("<link rel=\"stylesheet\" href=\"../css/mobile/desk_view.css\" />\n");
      out.write("<link rel=\"stylesheet\" href=\"../css/mobile/dish_order_list.css\" />\n");
      out.write("<link rel=\"stylesheet\" href=\"../css/mobile/dish_view.css\" />\n");
      out.write("<link rel=\"stylesheet\" href=\"../css/mobile/dish_order_view.css\">\n");
      out.write("<link rel=\"stylesheet\" href=\"../css/mobile/checkout_view.css\">\n");
      ...
      out.write("        <![endif]-->\n");
      out.write("</head>\n");
      out.write("<body id=\"fastclick\" onload=\"initFastButtons();\">\n");
      out.write("\t");
      out.write("\n");
      out.write("\n");
      ...
      out.write("\t\t\t\tclass=\"numberButton\">8人</label> <label id=\"totalPriceLabel\">¥100.0</label>\n");
      out.write("\t\t\t<label id=\"dishOrderBriefId\"></label> <label id=\"dishOrderCreateTime\"></label>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<div id=\"orderItemListDiv\" class=\"overthrow\">\n");
      out.write("\t\t\t<!-- drawDishOrderInfo -->\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<div id=\"deskOperationPanel\" class=\"overthrow\">\n");
      ...
      out.write("\t<div id=\"dishViewTop\">\n");
      out.write("\t\t<span id=\"dv_string_search_str\">查找</span>: <input type=\"text\"\n");
      out.write("\t\t\tname=\"dishFilterTextInput\" style=\"width: 5em\">\n");
      out.write("\t\t<button id=\"searchDishButton\" class=\"button\">搜索</button>\n");
      out.write("\t\t<button id=\"clearDishFilterButton\" class=\"button\">清空</button>\n");
      out.write("\t\t<span id=\"showPictureSpan\" style=\"display: none;\"><label\n");
      out.write("\t\t\tfor=\"showPictureCheckBox\"> 显示图片</label><input\n");
      out.write("\t\t\tid=\"showPictureCheckBox\" type=\"checkbox\"></span>\n");
      out.write("\n");
      out.write("\t</div>\n");
      out.write("\t<div id=\"dishCategorySelector\" class=\"overthrow\">\n");
      out.write("\t\t<button id=\"menuButton\" class=\"button\"></button>\n");
      out.write("\t\t<ul id=\"dishCategoryList\"></ul>\n");
      out.write("\t</div>\n");
      out.write("\t<div id=\"dishList\" class=\"overthrow\"></div>\n");
      out.write("\t<div id=\"dishPickerContainer\"></div>\n");
      out.write("\t<div class=\"viewBottom\">\n");
      out.write("\t\t<button id=\"cancelDishOrderButton\"\n");
      out.write("\t\t\tclass=\"dishOrderCmdButton floatLeft\">取消</button>\n");
      out.write("\t\t<button id=\"showSearchKeyboardButton\"\n");
      out.write("\t\t\tclass=\"dishOrderCmdButton floatLeft\">键盘</button>\n");
      out.write("\t\t<button id=\"freeHandwriteButton\" class=\"dishOrderCmdButton floatLeft\">自由写</button>\n");
      out.write("\t\t<button id=\"confirmDishOrderButton\"\n");
      out.write("\t\t\tclass=\"dishOrderCmdButton floatRight\">已点</button>\n");
      out.write("\t</div>\n");
      out.write("</div>");
      out.write('\n');
      out.write('	');
      out.write("\n");
      out.write("\n");
      out.write("<div id=\"dishOrderView\" style=\"display: none;\">\n");
      out.write("\t<div id=\"dishOrderViewTop\"></div>\n");
      out.write("\t<div id=\"dishOrderItemList\" class=\"overthrow\"></div>\n");
      out.write("\t<div class=\"viewBottom\">\n");
      out.write("\t\t<div style=\"font-size: 14px;\">\n");
      out.write("\t\t\t<span id=\"dov_string_deskNum\">桌号</span>:\n");
      out.write("\t\t\t <span id=\"deskNameLabel\">0</span>&nbsp;&nbsp;\n");
      out.write("\t\t\t <span id=\"dov_string_renShu\"> 人数</span>:\n");
      out.write("\t\t\t  <span\n");
      out.write("\t\t\t\tid=\"customerCountLabel\">0</span>&nbsp;&nbsp; \n");
      out.write("\t\t\t\t<span id=\"dov_string_total_price\">总价</span>: <span\n");
      out.write("\t\t\t\tid=\"totalPriceLabel\">0</span>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<hr />\n");
      out.write("\t\t<div>\n");
      out.write("\t\t\t<div style=\"width: 30%; float: left; text-align: left;\">\n");
      out.write("\t\t\t\t<div id=\"returnToDishViewButton\" class=\"dishOrderCmdButton\">返回</div>\n");
      out.write("\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t<div id=\"submitDishOrderButton\" class=\"dishOrderCmdButton\">下单</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t</div>\n");
      out.write("\t</div>\n");
      out.write("</div>\n");
      ...
      out.write("\t<div id=\"checkoutViewContent\" class=\"overthrow\">\n");
      ...
      out.write("\t\t<div class=\"dishOrderCmdButton\" id=\"prePrintCheckoutBillButton\">预打结账单</div>\n");
      out.write("\t\t<button class=\"dishOrderCmdButton floatLeft\" id=\"cancelCheckoutButton\">取消付款</button>\n");
      out.write("\t</div>\n");
      out.write("</div>");
      out.write('\n');
      out.write('	');
      ...
      out.write("\t<script type=\"text/javascript\" src=\"../js/vendor/fastclick.js\"></script>\n");
      ...
      out.write("\t\tcharset=\"utf-8\"></script>\n");
      out.write("\t<script type=\"text/javascript\" src=\"../js/mobile/work_console.js\"\n");
      out.write("\t\tcharset=\"utf-8\"></script>\n");
      out.write("\t<script type=\"text/javascript\" src=\"../js/mobile/dish_order_list.js\"\n");
      out.write("\t\tcharset=\"utf-8\"></script>\n");
      out.write("\t<script type=\"text/javascript\" src=\"../js/mobile/dish_view.js\"\n");
      out.write("\t\tcharset=\"utf-8\"></script>\n");
      out.write("\t<script type=\"text/javascript\" src=\"../js/mobile/dish_order_view.js\"\n");
      out.write("\t\tcharset=\"utf-8\"></script>\n");
      out.write("</body>\n");
      out.write("</html>\n");
    } catch (Throwable t) {
